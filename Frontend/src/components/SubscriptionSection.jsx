...
import { Mail, TrendingUp, BookOpen, Target, Loader2, ArrowRight, Check } from 'lucide-react';
...
const SubscriptionSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://trading-tool-1.onrender.com/api/store', {
        method: 'POST',
        headers: {
    ...
    <div className="w-full bg-black py-24">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-400 text-xl mb-8">
              Perfect your trading strategies using virtual currency on real market data.
            </p>
            ...
            <form onSubmit={handleSubmit} className="relative mb-8">
              ...
              {status === 'success' && (
                <div className="absolute -bottom-8 left-0 text-blue-500 flex items-center space-x-1">
                  <Check size={16} />
                  <span>You're on the waitlist!</span>
                </div>
              )}
              {status === 'error' && (
                <div className="absolute -bottom-8 left-0 text-red-500">
          ...
          <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
            <div className="grid grid-cols-2 gap-8">
              {benefits.map((stat) => (
                <div key={stat.id} className="text-center p-6 bg-black rounded-xl border border-gray-800">
              ...
              <div className="col-span-2">
                <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-xl p-6 text-center">
                  <div className="text-3xl font-bold text-white mb-2">Practice Trading</div>
        ...
        <div className="text-center">
          <p className="text-gray-400 mb-4">Practice with real market data from</p>
          <div className="flex justify-center space-x-8">
            {['NSE', 'BSE'].map((exchange) => (
              <div key={exchange} className="text-gray-600 font-semibold text-xl">
                {exchange}
              </div>
            ))}
          </div>
